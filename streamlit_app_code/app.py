...
# st.sidebar.header("Select your detection task here")

# Set the default values
mlmodel_radio = 'Detection'
conf = 0.5  # Minimum accuracy score fixed at 50%

# Display the default task and description
# st.sidebar.write("**Task:** Detection")
# st.sidebar.write("Perform object detection on images.")
# st.sidebar.write("---")
...
# conf = float(st.sidebar.slider("Select Minimum Accuracy Score. Recommended: Minimum 50%", 25, 100, 40)) / 100
# if mlmodel_radio == 'Detection':
#     dirpath_locator = settings.DETECT_LOCATOR
#     model_path = Path(settings.DETECTION_MODEL)
# elif mlmodel_radio == 'Segmentation':
